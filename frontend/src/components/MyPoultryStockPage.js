...
const MyPoultryStockPage = ({ currentUser, onNavigate }) => {
  ...
  // Actions principales pour vendre rapidement
  const produitsAVendre = [
    {
      id: 'poules',
      nom: 'Poules pondeuses',
      icon: '🐔',
      description: 'Vendez vos poules qui pondent bien',
    ...
    },
    {
      ...
      icon: '🐓',
      description: 'Vendez vos poulets prêts à manger',
      action: () => onNavigate('vendre-volailles')
    },
    {
      id: 'oeufs',
      nom: 'Œufs à vendre',
      icon: '🥚',
      description: 'Vendez vos œufs frais ou fécondés',
      action: () => onNavigate('vendre-volailles')
    },
    {
      id: 'poussins',
    ...
    },
    {
      ...
      nom: 'Pintades',
      icon: '🦃',
      description: 'Vendez vos pintades adultes',
      action: () => onNavigate('vendre-volailles')
    },
    {
      id: 'canards',
      nom: 'Canards',
      icon: '🦆',
      description: 'Vendez vos canards',
      action: () => onNavigate('vendre-volailles')
    }
  ];
        ...
        <div className="max-w-md mx-auto">
          ...
          >
            ...
            <div className="text-sm mt-2 opacity-90">
              Vendez vos volailles rapidement
            </div>
          </button>
        </div>
      </div>
      ...
      <div className="px-4">
        <div className="max-w-md mx-auto">
          <h2 className="text-lg font-bold mb-4 text-center" style={{ color: colors.text }}>
            🔗 Ou choisissez le type de volaille :
          </h2>
        ...
        <div className="max-w-md mx-auto">
          ...
          >
            ...
            <div className="text-sm text-green-700 space-y-1">
              ...
              <p>2️⃣ Prenez une photo de vos volailles</p>
